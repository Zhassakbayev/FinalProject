...
public class ProfileValidator extends Validator {
    ...
    public static boolean validateUserParameters(String firstName,String lastName,String secondName,String dateOfBirth,
                                                 String email,String password,String lang){
        return  Validator.checkForFilled(firstName,lastName,secondName,password,lang,dateOfBirth,email,dateOfBirth) && validateEmail(email) && isDateValid(dateOfBirth) ;
